        ...
        <div>
          ...
          <div style={{ fontFamily: '\'Helvetice Neue\', helvetica, arial, sans-serif', padding: '15px 40px', display: 'flex', flexDirection: flexDir }}>
            <div>
              ...
              <p>
                <h4 style={{ fontWeight: 700, color: '#39395a' }}><a href="http://www.vanaqua.org/learn/camps" target="_blank">Camps & Clubs</a></h4> <br /> Programs embrace nature play, science, art and hands-on experiences to foster a love of our natural world.
              </p>
              <p>
                <h4 style={{ fontWeight: 700, color: '#39395a' }}><a href="http://www.vanaqua.org/experience/activities/sleepovers" target="_blank">Sleepovers</a></h4> <br /> Participants spend the night at the Vancouver Aquarium and visit the Wet Lab to explore the three corners of the world.
              </p>
              <p>
                <h4 style={{ fontWeight: 700, color: '#39395a' }}><a href="http://www.vanaqua.org/plan/birthdays" target="_blank">Birthday Parties</a></h4> <br /> Participants tour the Aquarium with an experienced educator and engage in a multisensory exploration of the BC intertidal zone in our Wet Lab.
              </p>
              <p>
                <h4 style={{ fontWeight: 700, color: '#39395a' }}><a href="http://www.vanaqua.org/join/hands-on/work-experience" target="_blank">Youth Leadership</a></h4> <br /> Participants are immersed in conservation and sustainability workshops led by our educators, experts and scientists. We alse mentor the next generation of ocean champions through work experience volunteer placements each year.
              </p>
              <Blockquote>
